...
public class Semifinales extends General{
	...
	public Semifinales (Controlador c){
		...
		SEquipo1.setBounds(CANCHA_TAMANO_RECT_G/2 - CANCHA_TAMANO_RECT_C/2,CANCHA_TAMANO_RECT_G/2 + AUM_Y_BTTN/2,WIDTH/2 - CANCHA_TAMANO_RECT_C + 28 + AUMENTO_FUENTE*10,TAM_LABEL.height);
